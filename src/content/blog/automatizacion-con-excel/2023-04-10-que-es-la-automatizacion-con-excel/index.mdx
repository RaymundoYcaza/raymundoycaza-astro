...
import { default as genericCover, default as img2 } from '/src/assets/images/2023/ry-portada-generica.png';
...
<YouTube
  title="¿Qué es Excel y para qué se usa?"
  videoId="phy-h61Xnlg"
/> 
...
<PostPreview       
      postName="que-es-excel">
      <Picture src={genericCover} alt="" slot="picture"/>
      <span slot="title">¿Qué es Excel? ¿Para qué sirve? Excel desde cero.</span>
      <span slot="description">Descubre qué es Excel, para qué sirve y quiénes lo usan... en un minuto.</span>
...
<PostPreview       
      postName="que-es-una-formula-en-excel">
      <Picture src={img3} alt="¿Qué es una fórmula en Excel?" slot="picture" objectFit="contain" breakpoints={{ count: 3, minWidth: 300, maxWidth: 1024 }}/>
      <span slot="title">¿Qué es una fórmula en Excel?</span>
      <span slot="description">Descubre lo que es una fórmula, para qué sirve y cómo se usa.</span>
...
<PostPreview       
      postName="elementos-basicos-de-una-formula">
      <Picture src={img4} alt="¿Qué es una fórmula en Excel?" slot="picture" objectFit="contain" breakpoints={{ count: 3, minWidth: 300, maxWidth: 1024 }}/>
      <span slot="title">7 elementos básicos de una fórmula, que tú debes conocer</span>
      <span slot="description">Aprende cómo están compuestas las fórmulas en Excel y conócelas mejor.</span>
      <span slot="footer">#Fórmulas #Excel #Automatización</span>
</PostPreview>
