...
import img2 from '../2012-06-11-que-es-excel/images/excel-desde-cero.png';
...
![Qué es la automatización con Excel](./images/que-es-la-automatizacion-con-excel_portada.png)
...
<PostPreview       
      ...
      <Picture src={img2} alt="" slot="picture"/>
...
<PostPreview
    ...
    footer='#Aprendiendo Excel, #Excel Básico, #🤖 Automatización con Excel'>
Descubre cuáles son los componentes de Excel, la hoja de cálculo más popular del mundo.
</PostPreview>
