...
import img4 from "../2014-10-01-7-elementos-basicos-de-una-formula-de-excel/images/img_542b6d8e6b9a9.png";
...
<PostPreview postName="que-es-una-formula-en-excel">
  <Picture
    src={img3}
    alt="¿Qué es una fórmula en Excel?"
    slot="picture"
    objectFit="contain"
    breakpoints={{ count: 3, minWidth: 300, maxWidth: 1024 }}
  />
  <span slot="title">¿Qué es una fórmula en Excel?</span>
  <span slot="description">
    Descubre lo que es una fórmula, para qué sirve y cómo se usa.
  </span>
  <span slot="footer">#Fórmulas #Excel #Automatización</span>
</PostPreview>

---

<PostPreview postName="elementos-basicos-de-una-formula">
  <Picture
    src={img4}
    alt="¿Qué es una fórmula en Excel?"
    slot="picture"
  ...
  <span slot="description">
    Aprende cómo están compuestas las fórmulas en Excel y conócelas mejor.
  </span>
  <span slot="footer">#Fórmulas #Excel #Automatización</span>
</PostPreview>
