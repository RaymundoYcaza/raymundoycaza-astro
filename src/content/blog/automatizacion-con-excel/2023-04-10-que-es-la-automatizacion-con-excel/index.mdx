...
cover: "./images/que-es-automatizar-en-excel_portada.png"
...
import ExcelFormula from "/src/components/ExcelFormula.astro";
...
![Ventajas de la automatización con Excel](./images/automatizacion-excel_003.png)
...
## Qué significa automatizar con Excel <br />(sin el rollo técnico)
...
![Qué es la automatización con Excel](./images/automatizacion-excel_006.png)
...
## Cómo funciona la automatización <br />en la vida real

![Automatizando con Excel](./images/automatizacion-excel_004.png)
...
![Qué es la automatización con Excel](./images/automatizacion-excel_002.png)
...
<ExcelFormula
  name="SUMA"
  params={[
    { label: "número 1", description: "Primer valor a sumar" },
    { label: "número 2", description: "Segundo valor a sumar" },
    { label: "número N", description: "Ingresa tantos valores como necesites" },
  ]}
/>
...
<ExcelFormula
  name="PROMEDIO"
  params={[
    { label: "número 1", description: "Primer valor a promediar" },
    { label: "número 2", description: "Segundo valor a promediar" },
    { label: "número N", description: "Ingresa tantos valores como necesites" },
  ]}
/>
...
<CalloutNumbered number={1} title="Usa referencias absolutas">
  Cuando no quieras que una celda cambie al copiar la fórmula hacia abajo o
  hacia la derecha, usa [referencias
  absolutas](/automatizacion-con-excel/referencias-absolutas-y-relativas)
</CalloutNumbered>

<CalloutNumbered number={2} title="Envuelve tus fórmulas con SI.ERROR()">
  Envuelve tus fórmulas con `SI.ERROR()` para manejar valores inválidos sin
  romper todo
</CalloutNumbered>

<CalloutNumbered number={3} title="Mantenlo simple">
...
![Qué es la automatización con Excel](./images/automatizacion-excel_001.png)
...
## Tu próximo paso <br />(el más importante)
