...
![Crear varias carpetas a la vez](./images/crear-varias-carpetas-a-la-vez_portada.png)
...
![Crear varias carpetas a la vez](./images/crear-varias-carpetas-a-la-vez-000002.png) ¿Has notado cómo he nombrado a la carpeta 'madre'? `201305201149-EXCEL-NombreCliente`
...
> 📝 **Nota**: Yo he agregado la hora porque en mi caso, recibo en el mismo día pedidos nuevos del mismo cliente y esto me ayuda a que el nombre no se repita y así poder manejar los proyectos por separado, a pesar de pertenecer al mismo cliente.
...
 
![Crear varias carpetas a la vez](./images/crear-varias-carpetas-a-la-vez-000003.png)

 
Al final, debe quedarte un 'Archivo por lotes de Windows', así:

![Crear varias carpetas a la vez](./images/crear-varias-carpetas-a-la-vez-000004.png)
...
![Crear varias carpetas a la vez](./images/crear-varias-carpetas-a-la-vez-000005.png)
